...
<body>
    ...
    <div class="text-center">
        ...
        <h5 class="mx-auto mt-3 fs-6"><?php echo $_SESSION['username'];?></h5>
    ...
    <div class="pt-3 d-flex">
        <ul class="nav nav-link mx-auto">
            ...
            <li>
                <a href="courses.php" class="btn border-0 btn-outline-info text-dark">
            ...
            <li>        
                <a href="logout.php" class="btn border-0 btn-outline-info text-dark mt-5">
