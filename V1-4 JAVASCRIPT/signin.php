    ...
    <form method="POST" action="#">
        <div class="p-5" id="div_nbr_1" style=" background-image: linear-gradient(60deg,#00C1FE,#2ccafa,#FAFFC1); background-repeat: no-repeat;">
            ...
            <h6 class="fw-bold text-center mt-5">SIGN IN</h6>
                ...
                <input type="email" name="email" value="<?= $_COOKIE['email'] ??'' ?>" class="ps-3 py-2 border-secondery form-control fw-light" placeholder="Enter your email" required><br>
                <label for="password" class="mb-2">Password</label><br>
                <input type="password" name="password" value='<?= $_COOKIE['password'] ??'' ?>'class=" ps-3 py-2 border-secondery form-control fw-light" placeholder="Enter your password" required>
                ...
                <p class="mt-4 text-center text-secondery fw-normal mb-0" style=" color: grey;">Forgot your password? 
                    <a href="dashboard.php" class="d-f text-info mt-0">Reset Password</a>
                    <a href="signup.php" class="d-f text-info ms-5 mt-0">Sign Up</a>
                </p>
            </div>
        </div>
    </form>
